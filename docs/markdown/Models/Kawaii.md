...
| **netip** | [**KawaiiNetIp**](KawaiiNetIp.md) | The Kawaii list of assigned virtual IPs per-zone addresses (read-only). | [optional] [default to null] |
| **firewall** | [**KawaiiFirewall**](KawaiiFirewall.md) | The Kawaii firewall settings from/to public Internet). | [optional] [default to null] |
